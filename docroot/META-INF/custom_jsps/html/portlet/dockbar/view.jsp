...
<div class="dockbar" data-namespace="<portlet:namespace />" id="dockbar">
	<ul class="aui-toolbar">
		...
		<c:if test="<%= !group.isControlPanel() && themeDisplay.isShowPageSettingsIcon() && themeDisplay.isShowControlPanelIcon() || themeDisplay.isShowPageSettingsIcon() || themeDisplay.isShowLayoutTemplatesIcon() %>">
	...
	<ul class="aui-toolbar user-toolbar">
		<c:if test="<%= user.hasMyPlaces() && themeDisplay.isShowPageSettingsIcon() %>">
